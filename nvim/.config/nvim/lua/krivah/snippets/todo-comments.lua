...
local get_cstring = function(ctype)
  ...
  return #cstring_table == 1 and { cstring_table[1], '' }
...
_G.luasnip.vars = {
  ...
  github = 'https://github.com/krivahtoo',
  real_name = 'Noah Cheptoo',
}
...
local marks = {
  ...
  date_signature = function()
    return fmt(
      '<{}{}>',
      { i(1, os.date '%d-%m-%y'), i(2, ', ' .. _G.luasnip.vars.username) }
    )
  end,
  date = function()
