...
local syntax_template = [[
  ...
  syn match qfError '^[%s] ' nextgroup=qfFileName
  syn match qfWarning '^[%s] ' nextgroup=qfFileName
  syn match qfHint '^[%s] ' nextgroup=qfFileName
  syn match qfInfo '^[%s] ' nextgroup=qfFileName

  syn match qfVisibleWithPath '^%s' nextgroup=qfFileName cchar= conceal
  syn match qfVisibbleWithoutPath '^%s' cchar= conceal
  syn match qfHiddenWithPath '^%s' nextgroup=qfFileName conceal
  syn match qfHiddenWithoutPath '^%s' conceal

  syn match qfFileName '[^:]\+' contains=qfPath contained
  syn match qfPath '[^:]\+/' nextgroup=qfPosition contained
  syn match qfPosition ':[0-9]\+\(:[0-9]\+\)\?'
