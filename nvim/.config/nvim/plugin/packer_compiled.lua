...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/krivah/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-buffer", "cmp-calc", "cmp-cmdline", "cmp-dictionary", "cmp-npm", "cmp-emoji", "cmp-git", "cmp-nvim-lua", "cmp-path", "cmp-rg", "cmp-spell", "cmp-treesitter", "cmp_luasnip", "cmp-digraphs" },
  ...
  ["nvim-config-local"] = {
    config = { "\27LJ\2\nı\1\0\0\6\0\f\0\0176\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\0026\3\6\0009\3\a\0039\3\b\3'\5\t\0B\3\2\2'\4\n\0&\3\4\3=\3\v\2B\0\2\1K\0\1\0\rhashfile\18/config-local\tdata\fstdpath\afn\bvim\17config_files\1\0\4\20commands_create\2\24autocommands_create\2\vsilent\1\19lookup_parents\1\1\3\0\0\15.vimrc.lua\v.vimrc\nsetup\17config-local\frequire\0" },
    loaded = true,
  ...
  ["nvim-gomove"] = {
    ...
    keys = { { "x", "<C-Right>" }, { "x", "<C-Left>" }, { "x", "<C-Up>" }, { "x", "<C-Right>" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
  ...
  ["nvim-lightbulb"] = {
    config = { "\27LJ\2\n«\1\0\0\a\0\t\0\f6\0\0\0009\0\1\0009\0\2\0005\2\3\0005\3\4\0006\4\5\0'\6\6\0B\4\2\0029\4\a\4=\4\b\3B\0\3\1K\0\1\0\rcallback\21update_lightbulb\19nvim-lightbulb\frequire\1\0\2\fpattern\6*\tdesc\26Lightbulb autocommand\1\3\0\0\15CursorHold\16CursorHoldI\24nvim_create_autocmd\bapi\bvim\0" },
    load_after = {
      ["nvim-lspconfig"] = true
    },
    loaded = false,
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "nvim-lightbulb", "lspsaga.nvim", "null-ls.nvim", "fidget.nvim" },
