...
_G.packer_plugins = {
  ...
  ["auto-session"] = {
    config = { "\27LJ\2\nè\1\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0005\3\4\0=\3\5\2B\0\2\1K\0\1\0\31auto_session_suppress_dirs\1\5\0\0\a~/\15~/Projects\r~/github\17~/Playground\1\0\4\14log_level\twarn\22auto_save_enabled\1 auto_session_create_enabled\1 auto_session_use_git_branch\2\nsetup\17auto-session\frequire\0" },
    loaded = true,
  ...
  ["nvim-cmp"] = {
    after = { "cmp-path", "cmp-calc", "cmp-cmdline", "cmp-spell", "cmp-digraphs", "cmp-treesitter", "cmp-emoji", "cmp-git", "cmp-dictionary", "cmp-rg", "cmp_luasnip", "cmp-npm", "cmp-buffer", "codeium.nvim", "cmp-nvim-lsp", "cmp-nvim-lua" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "null-ls.nvim", "lsp_signature.nvim", "lspsaga.nvim", "nvim-lightbulb" },
