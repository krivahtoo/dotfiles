...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-calc", "cmp-nvim-lua", "cmp-dictionary", "cmp-treesitter", "cmp-rg", "cmp-buffer", "cmp-cmdline", "cmp-git", "cmp-spell", "cmp-npm", "cmp-emoji", "cmp-path", "cmp-digraphs", "cmp_luasnip" },
  ...
  ["nvim-lspconfig"] = {
    after = { "lsp_signature.nvim", "null-ls.nvim", "fidget.nvim", "nvim-lightbulb", "lspsaga.nvim" },
  ...
  ["telescope-undo.nvim"] = {
    loaded = true,
    path = "/home/krivah/.local/share/nvim/site/pack/packer/start/telescope-undo.nvim",
