...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "lspsaga.nvim", "nvim-cmp", "lsp-colors.nvim" },
    loaded = true,
    only_config = true
  },
  ["nvim-notify"] = {
  ...
  ["symbols-outline.nvim"] = {
    loaded = true,
    path = "/home/krivah/.local/share/nvim/site/pack/packer/start/symbols-outline.nvim",
