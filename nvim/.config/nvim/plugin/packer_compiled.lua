...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-git", "cmp-nvim-lua", "cmp_luasnip", "cmp-digraphs", "cmp-calc", "cmp-dictionary", "cmp-cmdline", "cmp-buffer", "cmp-path", "cmp-rg", "cmp-treesitter", "cmp-spell", "cmp-nvim-lsp", "cmp-npm", "cmp-emoji" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-lightbulb", "fidget.nvim", "lspsaga.nvim", "lsp_signature.nvim", "null-ls.nvim" },
